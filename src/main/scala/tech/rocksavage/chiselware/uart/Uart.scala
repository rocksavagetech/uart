...
class Uart(val params: UartParams) extends Module {
  ...
  val rxMaxClocksPerBit: UInt = RegInit(0.U(log2Ceil(params.maxClocksPerBit).W))
  registerMap.createAddressableRegister(rxMaxClocksPerBit, "rxMaxClocksPerBit")
  ...
  val txMaxClocksPerBit: UInt = RegInit(0.U(log2Ceil(params.maxClocksPerBit).W))
  registerMap.createAddressableRegister(txMaxClocksPerBit, "txMaxClocksPerBit")
